/*
  # Add Language Preferences Support
  ...
  4. Functions
    - `get_or_create_user_preferences` - Get or create user preferences
    - `update_user_language` - Update user language preference
    - `get_user_language` - Get user's preferred language
    - Updated `get_pending_questions` - Include language preferences

  5. Performance
    - Add indexes for better query performance
    - Create language usage statistics view
*/

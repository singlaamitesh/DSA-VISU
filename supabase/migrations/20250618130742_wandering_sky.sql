/*
  # Add User Preferences Table for Language Selection
  ...
  2. Updates to Existing Tables
    ...
    - Add language-specific indexes for better performance
  ...
  4. Functions
    ...
    - Add language validation functions
*/
...
-- Update the get_pending_questions function to include language preferences
